...
// Get level styling (color, shape, border) - copied from dashboard.js
...
// Format timestamp as relative time with username
function formatTimestamp(timestamp, username) {
