...
def calculate_level(hash_str: str) -> float:
    ...
    Examples:
        "00000000001..." (10 zeros, then '1') -> level 5.94
        "0000000000f..." (10 zeros, then 'f') -> level 5.03
        "000000000001..." (11 zeros, then '1') -> level 6.94
